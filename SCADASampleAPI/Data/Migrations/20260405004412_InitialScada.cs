    ...
    public partial class InitialScada : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScadaTags", x => x.TagId);
                    table.ForeignKey(
                        name: "FK_ScadaTags_Pipelines_PipelineId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SetPoint = table.Column<float>(type: "real", nullable: false),
                    Severity = table.Column<int>(type: "int", nullable: false),
                    Message = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    IsEnabled = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    RaisedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScadaAlarms", x => x.AlarmId);
                    table.ForeignKey(
                        name: "FK_ScadaAlarms_Pipelines_PipelineId",
                        column: x => x.PipelineId,
                        principalTable: "Pipelines",
                        principalColumn: "PipelineId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScadaAlarms_ScadaTags_TagId",
                        column: x => x.TagId,
                        principalTable: "ScadaTags",
                        principalColumn: "TagId",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ScadaAlarms_PipelineId",
                table: "ScadaAlarms",
                column: "PipelineId");

            migrationBuilder.CreateIndex(
                name: "IX_ScadaAlarms_TagId",
                table: "ScadaAlarms",
                column: "TagId");
